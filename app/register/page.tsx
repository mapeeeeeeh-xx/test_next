  ...
  const onSubmit: SubmitHandler<FormData> = async (data) => {
    ...
    try {
      ...
      if (res.retcode === "200") {
        ...
        setError("api" as keyof FormData, { type: "manual", message: res.message }) // Type assertion here
      }
    } catch (e) {
      console.error("Error during registration:", e)
      setError("api" as keyof FormData, { type: "manual", message: "Register Failed. Please try again" }) // Type assertion here
    }
  }
        ...
        <FormProvider {...methods}>
          <form onSubmit={handleSubmit(onSubmit)} className='space-y-4'>
            ...
            <span className='text-center'>
              <Link href={loginURL}>
                <p className='text-blue-400 hover:underline pt-4'>Have an account? Log in here</p>
              </Link>
            </span>
