    ...
    <div className='bg-black flex items-center justify-center h-screen'>
        <div className='bg-gray-800 text-slate-500 p-8 rounded-lg shadow-lg w-full max-w-sm'>
            ...
            <form onSubmit={handleSubmit} className='space-y-4'>
                <div>
                    <label htmlFor="identifier" className='block text-lg font-medium mb-2'>Email or Username</label>
                    <input
                        type="text"
                        id="identifier"
                        name="identifier"
                ...
                <div className='text-center'>
                    <Link href={registerURL}>
                        <p className='text-blue-400 hover:underline'>No account yet? Register here</p>
                    </Link>
                </div>
            </form>
        </div>
